 ...
 * @param {object} opts
 */
export function Transpile(syntax, source, { mode = TranspileMode.REPLACE, segment = null, verbose = false, only_preprocess=false, only_parse=false, only_resolve_pat=false } = {}) { //opts as a dictionary of opts with defaults
